            ...
            <form action="{{ url('/resume_receiving') }}" method="POST" id="submit_cfs">
                        ...
                        <div class="row shadow bg-white pt-3">
                            ...
                            <div class="col col-lg-3 col-md-3 col-sm-12 col-12 text-center">
                                <div class="card text-dark bg-light border-dark mb-3">
                                    ...
                                    <div class="card-body">
                                        <input type="text" class="form-control border border-dark mb-3  text-center"
                                            name="veh_type" value="{{ $data_cfs->veh_type }}">
                                    </div>
                                </div>
                            </div>
                            <div class="col col-lg-3 col-md-3 col-sm-12 col-12 text-center">
                                <div class="card text-dark bg-light border-dark mb-3">
                                    ...
                                    <div class="card-body">
                                        <input type="text" class="form-control border border-dark mb-3  text-center"
                                            name="veh_id" value="{{ $data_cfs->veh_id }}">
                                    </div>
                                </div>
                            </div>
                            <div class="col col-lg-3 col-md-3 col-sm-12 col-12 text-center">
                                <div class="card text-dark bg-light border-dark mb-3">
                                    ...
                                    <div class="card-body">
                                        <input type="text" class="form-control border border-dark mb-3  text-center"
                                            name="con_size" value="{{ $data_cfs->con_size }}">
                                    </div>
                                </div>
                            </div>
                            <div class="col col-lg-3 col-md-3 col-sm-12 col-12 text-center">
                                <div class="card text-dark bg-light border-dark mb-3">
                                    ...
                                    <div class="card-body">
                                        <input type="text" class="form-control border border-dark mb-3  text-center"
                                            name="con_act" value="{{ $data_cfs->con_act }}">
                                    </div>
                                </div>
                            </div>
                            <div class="col col-lg-3 col-md-3 col-sm-12 col-12 text-center">
                ...
                <div class="d-flex justify-content-between position-sticky">
                    ...
                    <button type="submit" class="btn btn-success position-sticky bottom-0 end mb-3" id="send_cfs"
                        ...
                        formaction="{{ url('/resume_receiving') }}">Pending</button>

                    <button type="submit" class="btn btn-success position-sticky bottom-0 end mb-3" id="send_cfs"
                        data-bs-toggle="modal" data-bs-target="#submit_worksheet"
                        formaction="{{ url('/finish_resume_receiving') }}">submit</button>
                </div>
            </form>
        </section>
