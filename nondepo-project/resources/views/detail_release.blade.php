                        ...
                        <form action="{{ route('resume_cfs_release', ['id' => $data_cfs->id_job_order]) }}" method="get">
                            ...
                            <div class="row justify-content-center align-items-center h-100">
                                <div class="col col-lg-6 col-md-6 col-sm-12 p-0 m-0 text-center">
                                    <h4 class="fw-bold">CFS CARGO RELEASE</h4>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col col-lg-6 col-md-6 col-sm-12">
                                            <div class="card mb-4 border border-dark border-2">
                                                <div class="card-header bg-dark border-dark text-center">
                            ...
                            <div class="row">
                                ...
                                <div class="col col-lg-3 col-md-6 col-sm-12 col-12">
                                    <div class="card mb-4 border border-dark border-2">
                                        <div class="card-header bg-dark text-center">
                                            <p class="text-white m-0 fw-bold">VEHICLE TYPE:</p>
                                        </div>
                                        <div class="card-body text-center my-auto p-2">
                                ...
                                <div class="col col-lg-3 col-md-6 col-sm-12 col-12">
                                    <div class="card mb-4 border border-dark border-2">
                                        <div class="card-header bg-dark text-center">
                                            <p class="text-white m-0 fw-bold">VEHICLE ID:</p>
                                        </div>
                                        <div class="card-body text-center my-auto p-2">
                                ...
                                <div class="col col-lg-3 col-md-4 col-sm-12 col-12">
                                    <div class="card mb-4 border border-dark border-2">
                                        <div class="card-header bg-dark text-center">
                                            <p class="text-white m-0 fw-bold">CONTAINER NO/SIZE:</p>
                                        </div>
                                        <div class="card-body text-center my-auto p-2">
                            ...
                            <div class="row">
                                <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div class="card mb-4 border border-dark border-2">
                                        <div class="card-header bg-dark text-center">
                                            <p class="text-white m-0 fw-bold">CONTAINER ACTIVITY TYPE (if using container):
                                            </p>
                                        </div>
                                        <div class="card-body text-center my-auto p-2">
